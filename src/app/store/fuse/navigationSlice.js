...
// import navigationConfig from 'app/fuse-configs/studentNavigationConfig';
...
const emptyInitialState = navigationAdapter.getInitialState({ activeRoute: null });
...
export const { setNavigation, resetNavigation, setActiveRoute } = navigationSlice.actions;
