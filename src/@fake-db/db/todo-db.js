...
mock.onGet('/api/reports/SectionWiseCourse').reply(200,
 {
status: true,
    message: "",
    body:{
		...
		options: {
			...
			xaxis: {
				categories: ['section5', 'section4', 'section3', 'section2', 'section1']
			}
		}
	} }
 );
...
mock.onGet('/api/reports/QuestionWiseAnalysisBar').reply(200,
 {
status: true,
    message: "",
    body:{
...
colors: ['#2196F3', '#4CAF50', '#FED441'],
		...
		xaxis: {
			categories: ['Botany', 'Zoology', 'Physics', 'Chemistry', 'Total']
		},
		yaxis: {
			// title: {
			// 	text: '$ (thousands)'
...
mock.onGet('/api/reports/QuestionWiseAnalysisPie').reply(200,
 {
status: true,
    message: "",
    body:{
...
mock.onGet('/api/reports/TopicsToImprove').reply(200,
 {
status: true,
    message: "",
    body:[
...
mock.onGet('/api/reports/QuestionsAttempted').reply(200,
 {
status: true,
    message: "",
    body:{
...
mock.onGet('/api/reports/TopicsWiseAnalysis').reply(200,
 {
status: true,
    message: "",
    body:[] }
...
mock.onGet('/api/reports/QuestionWiseAnalysis').reply(200,
 {
status: true,
    message: "",
    body:{
...
mock.onGet('/api/reports/QuestionsWithAnswer').reply(200,
 {
status: true,
    message: "",
    body:[
		{
			question: 'Who is sudeesh',
			correctAnswer: 'A person',
			answerSelected: 'Fool',
			explanation: 'He is not a fool, If you think like that then you are a fool.',
			isOpend: false,
			isCorrect: true
		},
		{
...
mock.onGet('/api/reports/MarkScored').reply(200,
 {
status: true,
    message: "",
    body:{
